...
export class ExternalAPIsService {
    ...
    protected basePath = 'http://localhost/apis-externes';
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public postDemarcheSimplifie(payload: Query, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any>;
    public postDemarcheSimplifie(payload: Query, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<any>>;
    public postDemarcheSimplifie(payload: Query, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<any>>;
    public postDemarcheSimplifie(payload: Query, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
